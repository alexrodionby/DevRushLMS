...
struct AuthorizationMainView: View {
    ...
    private var emailPlaceholder: LocalizedStringKey = LocalizedStringKey("E-mail адрес...")
    private var passwordPlaceholder: LocalizedStringKey = LocalizedStringKey("Пароль...")
    private var loginButtonText: LocalizedStringKey = LocalizedStringKey("Войти")
    private var forgotPasswordButtonText: LocalizedStringKey = LocalizedStringKey("Забыли пароль?")
